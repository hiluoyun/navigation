...
bool MyMenu::init()
{
	...
	playIt=CCMenuItemSprite::create(playsp,playsp,this,menu_selector(MyMenu::menucallback));
...
void MyMenu::menucallback(CCObject* pSender){
	...
	case 2:
		...
		this->getParent()->addChild(ranklayer);
		break;
	case 3:
		aboutlayer = MyAboutLayer::create();
		this->getParent()->addChild(aboutlayer);
		break;
	case 4:
		helplayer = MyHelpLayer::create();
		this->getParent()->addChild(helplayer);
		break;
	case 5:
	...
	case 6:
		...
		this->getParent()->addChild(setlayer);
		break;
	default:
